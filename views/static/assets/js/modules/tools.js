(function ($) {
    ...
    if($("#functionTree").length > 0) {
        categoryUrl = $("#functionTree").attr("data-category-url");
    }
...
define(function(require, exports, module) {
    ...
    function zTreeOnClick(e, treeId, treeNode) {
        ...
        location.href = "/system/article/category_edit?id="+treeNode.id;
    };
    ...
    function beforeRemove(treeId, treeNode){
        ...
        if(confirm("是否删除？")){
            ...
            $.post('/admin/article/category_delete?id='+treeNode.id,function(data){
                // 从数据库中删除
                if(data.success){
                    // data  为 json 格式数据
    ...
    function onDrop(event, treeId, treeNodes, targetNode,moveType) {
        ...
        $.ajax({
            type:'post',
            url: '/system/article/category_drags?id='+treeNodes[0].id+'&pId='+pid,
            dataType: "text",
            async: false,
            success: function (data) {
            },
    ...
    function onRename(e, treeId, treeNode, isCancel) {
        //需要对名字做判定的，可以来这里写~~
        $.post('/system/article/category_edit?id='+treeNode.id+'&name='+treeNode.name),function (results) {
            if(results.code == 0){
    ...
    function onRemove(e, treeId, treeNode) {
        ...
        $.post('/system/article/category_delete?id='+treeNode.id);
    }
    ...
    function addHoverDom(treeId, treeNode) {
        ...
        if (btn) btn.bind("click", function(){
            ...
            $.post('/system/article/category_save?pid='+treeNode.id+'&name='+name,function (results) {
                if(results.code == 0){
