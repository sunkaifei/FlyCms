...
KindEditor.plugin('image', function(K) {
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
			...
			'<input type="text" name="localUrl" class="ke-input-text" tabindex="-1" style="width:100px;" readonly="true" /> &nbsp;',
			'<input type="button" class="ke-upload-button" value="' + lang.upload + '" />',
			'</div>',
			'</form>',
			'</div>',
		...
		var dialogWidth = showLocal || allowFileManager ? 330 : 330,
			dialogHeight = showLocal && showRemote ? 330 : 330;
		var dialog = self.createDialog({
			name : name,
			width : dialogWidth,
			height : dialogHeight,
